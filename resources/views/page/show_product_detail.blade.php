...
<div class="breadcrumbs">
    <div class="container">
        <div class="row">
            <div class="col">
                <p class="bread"><span><a href="http://localhost/shopShoe/public/">Home</a></span> / <span>Product Details</span></p>
            </div>
        </div>
    </div>
</div>
            ...
            <div class="col-sm-4">
                <div class="product-desc">
                    ...
                    <div class="input-group mb-4">
                        ...
                        <input type="hidden" id="quantity" name="product_id_hidden" class="form-control input-number" value="{{ $product->product_id}}" >
