                            ...
                            <ul>
                                ...
                                <li class="has-dropdown">
                                    ...
                                    <ul class="dropdown">
                                        ...
                                        <li><a href='http://localhost/shopShoe/public/danh-muc-san-pham/{{ $cate_pro->category_id}}'>
                                ...
                                <li class="has-dropdown">
                                    ...
                                    <ul class="dropdown">
                                        ...
                                        <li><a href="http://localhost/shopShoe/public/thuong-hieu-san-pham/{{ $brand_pro->brand_id}}">
                                        {{ $brand_pro->brand_name}}</a></li>
                                        @endforeach
                                    </ul>
                                </li>
