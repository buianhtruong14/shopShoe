        ...
        @foreach($all_category_product as $key => $cate_pro)
          <tr>
            ...
            <td>
              ...
              <a onclick="return confirm('Bạn chắc chắn muốn xóa chứ ?')" href="{{URL::to('/delete-category-product/'.$cate_pro->category_id)}}" class="active styling-edit" ui-toggle-class="">
